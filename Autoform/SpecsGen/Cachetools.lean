...
def dom_nonneg_cachetools___init___py__module__Cache___len : List Case :=
  [{ heap := h0 ++ [{ cls := "Cache", fields := [("_Cache__data", Val.dict [(Val.int (1), Val.int (1)), (Val.int (2), Val.int (2))]), ("_Cache__currsize", Val.int (2)), ("_Cache__maxsize", Val.int (2))] }], self := (some (Val.ref (base + 0))), args := [] },
   { heap := h0 ++ [{ cls := "Cache", fields := [("_Cache__data", Val.dict [(Val.int (1), Val.int (1)), (Val.int (2), Val.int (2))]), ("_Cache__currsize", Val.int (1)), ("_Cache__maxsize", Val.int (1))] }], self := (some (Val.ref (base + 0))), args := [] },
   { heap := h0 ++ [{ cls := "Cache", fields := [("_Cache__data", Val.dict []), ("_Cache__currsize", Val.int (0)), ("_Cache__maxsize", Val.int (2))] }], self := (some (Val.ref (base + 0))), args := [] },
   { heap := h0 ++ [{ cls := "Cache", fields := [("_Cache__data", Val.dict []), ("_Cache__currsize", Val.int (0)), ("_Cache__maxsize", Val.int (1000000))] }], self := (some (Val.ref (base + 0))), args := [] },
...
theorem nonneg_cachetools___init___py__module__Cache___len : ((dom_nonneg_cachetools___init___py__module__Cache___len).all (lawNonneg C FUEL f_cachetools___init___py__module__Cache___len__)) = true := by rfl

/-- Open: the same statement at **every** fuel budget ≥ `FUEL`. Proved only at `FUEL`. -/
def ob_nonneg_cachetools___init___py__module__Cache___len : Prop :=
  ∀ fuel, FUEL ≤ fuel → ((dom_nonneg_cachetools___init___py__module__Cache___len).all (lawNonneg C fuel f_cachetools___init___py__module__Cache___len__)) = true
...
def dom_runs_cachetools___init___py__module___TimedCache__Timer___reduce : List Case :=
  [{ heap := h0 ++ [{ cls := "_Timer", fields := [("_Timer__timer", Val.ref (base + 1)), ("_Timer__nesting", Val.int (0)), ("_Timer__time", Val.int (0))] }, { cls := "Timer", fields := [("auto", Val.bool false), ("time", Val.int (0))] }], self := (some (Val.ref (base + 0))), args := [] },
   ...
   { heap := h0 ++ [{ cls := "_Timer", fields := [("_Timer__timer", Val.ref (base + 1)), ("_Timer__nesting", Val.int (7))] }, { cls := "Timer", fields := [("auto", Val.bool false), ("time", Val.int (2))] }], self := (some (Val.ref (base + 0))), args := [] },
   { heap := h0 ++ [{ cls := "_Timer", fields := [("_Timer__timer", Val.ref (base + 1)), ("_Timer__nesting", Val.int (0)), ("_Timer__time", Val.int (0))] }, { cls := "Timer", fields := [("auto", Val.bool false), ("time", Val.int (-1))] }], self := (some (Val.ref (base + 0))), args := [] },
   { heap := h0 ++ [{ cls := "_Timer", fields := [("_Timer__timer", Val.ref (base + 1)), ("_Timer__nesting", Val.int (1)), ("_Timer__time", Val.int (0))] }, { cls := "Timer", fields := [("auto", Val.bool true), ("time", Val.int (0))] }], self := (some (Val.ref (base + 0))), args := [] }]
...
def dom_runs_cachetools___init___py__module___TimedCache_timer : List Case :=
  [{ heap := h0 ++ [{ cls := "TTLCache", fields := [("_Cache__data", Val.dict []), ("_Cache__currsize", Val.int (0)), ("_Cache__maxsize", Val.int (128)), ("_TimedCache__timer", Val.ref (base + 1)), ("_TTLCache__root", Val.ref (base + 2)), ("_TTLCache__links", Val.dict []), ("_TTLCache__ttl", Val.int (600))] }, { cls := "_Timer", fields := [("_Timer__timer", Val.fn "monotonic"), ("_Timer__nesting", Val.int (0))] }, { cls := "_Link", fields := [("expires", Val.unit), ("key", Val.unit), ("next", Val.ref (base + 2)), ("prev", Val.ref (base + 2))] }], self := (some (Val.ref (base + 0))), args := [] },
   ...
   { heap := h0 ++ [{ cls := "TLRUTestCache", fields := [("_Cache__data", Val.dict []), ("_Cache__currsize", Val.int (0)), ("_Cache__maxsize", Val.int (2)), ("_TimedCache__timer", Val.ref (base + 1)), ("_TLRUCache__items", Val.dict []), ("_TLRUCache__order", Val.list []), ("_TLRUCache__ttu", Val.fn "default_ttu")] }, { cls := "_Timer", fields := [("_Timer__timer", Val.ref (base + 2)), ("_Timer__nesting", Val.int (0)), ("_Timer__time", Val.int (0))] }, { cls := "Timer", fields := [("auto", Val.bool true), ("time", Val.int (1000000))] }], self := (some (Val.ref (base + 0))), args := [] },
   ...
   { heap := h0 ++ [{ cls := "TLRUTestCache", fields := [("getsizeof", Val.fn "CacheTestMixin.test_clear_getsizeof.<locals>.<lambda>"), ("_Cache__size", Val.dict []), ("_Cache__data", Val.dict []), ("_Cache__currsize", Val.int (0)), ("_Cache__maxsize", Val.int (10)), ("_TimedCache__timer", Val.ref (base + 1)), ("_TLRUCache__items", Val.dict []), ("_TLRUCache__order", Val.list []), ("_TLRUCache__ttu", Val.fn "default_ttu")] }, { cls := "_Timer", fields := [("_Timer__timer", Val.ref (base + 2)), ("_Timer__nesting", Val.int (7))] }, { cls := "Timer", fields := [("auto", Val.bool false), ("time", Val.int (7))] }], self := (some (Val.ref (base + 0))), args := [] },
   { heap := h0 ++ [{ cls := "TLRUTestCache", fields := [("getsizeof", Val.fn "CacheTestMixin.test_clear_getsizeof.<locals>.<lambda>"), ("_Cache__size", Val.dict []), ("_Cache__data", Val.dict []), ("_Cache__currsize", Val.int (0)), ("_Cache__maxsize", Val.int (7)), ("_TimedCache__timer", Val.ref (base + 1)), ("_TLRUCache__items", Val.dict []), ("_TLRUCache__order", Val.list []), ("_TLRUCache__ttu", Val.fn "default_ttu")] }, { cls := "_Timer", fields := [("_Timer__timer", Val.ref (base + 2)), ("_Timer__nesting", Val.int (0))] }, { cls := "Timer", fields := [("auto", Val.bool false), ("time", Val.int (-7))] }], self := (some (Val.ref (base + 0))), args := [] }]
...
def dom_idempotent_cachetools___init___py__module__TTLCache__Link___init : List Case :=
  [{ heap := h0 ++ [{ cls := "_Link", fields := [] }], self := (some (Val.ref (base + 0))), args := [Val.unit, Val.unit] },
   ...
   { heap := h0 ++ [{ cls := "_Link", fields := [] }], self := (some (Val.ref (base + 0))), args := [Val.tuple [Val.int (2)], Val.int (0)] }]
...
def dom_conform_cachetools___init___py__module__TTLCache__Link_unlink : List Obs :=
  [{ case := { heap := h0 ++ [{ cls := "_Link", fields := [("expires", Val.int (2)), ("key", Val.int (1)), ("next", Val.ref (base + 1)), ("prev", Val.ref (base + 2))] }, { cls := "_Link", fields := [("expires", Val.int (3)), ("key", Val.int (2)), ("next", Val.ref (base + 2)), ("prev", Val.ref (base + 0))] }, { cls := "_Link", fields := [("expires", Val.unit), ("key", Val.unit), ("next", Val.ref (base + 0)), ("prev", Val.ref (base + 1))] }], self := (some (Val.ref (base + 0))), args := [] }, expected := EResult.val (Val.unit) },
   ...
   { case := { heap := h0 ++ [{ cls := "_Link", fields := [("expires", Val.int (2)), ("key", Val.int (3)), ("next", Val.ref (base + 1)), ("prev", Val.ref (base + 2))] }, { cls := "_Link", fields := [("expires", Val.int (2)), ("key", Val.int (5)), ("next", Val.ref (base + 2)), ("prev", Val.ref (base + 0))] }, { cls := "_Link", fields := [("expires", Val.unit), ("key", Val.unit), ("next", Val.ref (base + 0)), ("prev", Val.ref (base + 1))] }], self := (some (Val.ref (base + 0))), args := [] }, expected := EResult.val (Val.unit) },
   { case := { heap := h0 ++ [{ cls := "_Link", fields := [("expires", Val.int (3)), ("key", Val.int (1)), ("next", Val.ref (base + 1)), ("prev", Val.ref (base + 3))] }, { cls := "_Link", fields := [("expires", Val.int (4)), ("key", Val.int (2)), ("next", Val.ref (base + 2)), ("prev", Val.ref (base + 0))] }, { cls := "_Link", fields := [("expires", Val.int (5)), ("key", Val.int (3)), ("next", Val.ref (base + 3)), ("prev", Val.ref (base + 1))] }, { cls := "_Link", fields := [("expires", Val.unit), ("key", Val.unit), ("next", Val.ref (base + 0)), ("prev", Val.ref (base + 2))] }], self := (some (Val.ref (base + 0))), args := [] }, expected := EResult.val (Val.unit) }]
...
def dom_runs_cachetools___init___py__module__TTLCache__Link_unlink : List Case :=
  [{ heap := h0 ++ [{ cls := "_Link", fields := [("expires", Val.int (2)), ("key", Val.int (1)), ("next", Val.ref (base + 1)), ("prev", Val.ref (base + 2))] }, { cls := "_Link", fields := [("expires", Val.int (3)), ("key", Val.int (2)), ("next", Val.ref (base + 2)), ("prev", Val.ref (base + 0))] }, { cls := "_Link", fields := [("expires", Val.unit), ("key", Val.unit), ("next", Val.ref (base + 0)), ("prev", Val.ref (base + 1))] }], self := (some (Val.ref (base + 0))), args := [] },
   ...
   { heap := h0 ++ [{ cls := "_Link", fields := [("expires", Val.int (4)), ("key", Val.int (3)), ("next", Val.ref (base + 1)), ("prev", Val.ref (base + 1))] }, { cls := "_Link", fields := [("expires", Val.int (0)), ("key", Val.int (0)), ("next", Val.ref (base + 0)), ("prev", Val.ref (base + 0))] }], self := (some (Val.ref (base + 0))), args := [] },
   { heap := h0 ++ [{ cls := "_Link", fields := [("expires", Val.int (4)), ("key", Val.int (1)), ("next", Val.ref (base + 1)), ("prev", Val.ref (base + 1))] }, { cls := "_Link", fields := [("expires", Val.int (0)), ("key", Val.unit), ("next", Val.ref (base + 0)), ("prev", Val.ref (base + 0))] }], self := (some (Val.ref (base + 0))), args := [] },
   { heap := h0 ++ [{ cls := "_Link", fields := [("expires", Val.int (4)), ("key", Val.int (3)), ("next", Val.ref (base + 1)), ("prev", Val.ref (base + 1))] }, { cls := "_Link", fields := [("expires", Val.unit), ("key", Val.int (0)), ("next", Val.ref (base + 0)), ("prev", Val.ref (base + 0))] }], self := (some (Val.ref (base + 0))), args := [] },
   { heap := h0 ++ [{ cls := "_Link", fields := [("expires", Val.int (3)), ("key", Val.int (1)), ("next", Val.ref (base + 1)), ("prev", Val.ref (base + 1))] }, { cls := "_Link", fields := [("expires", Val.unit), ("key", Val.unit), ("next", Val.ref (base + 0)), ("prev", Val.ref (base + 0))] }], self := (some (Val.ref (base + 0))), args := [] },
   { heap := h0 ++ [{ cls := "_Link", fields := [("expires", Val.int (7)), ("key", Val.int (1)), ("next", Val.ref (base + 1)), ("prev", Val.ref (base + 1))] }, { cls := "_Link", fields := [("expires", Val.int (0)), ("key", Val.int (0)), ("next", Val.ref (base + 0)), ("prev", Val.ref (base + 0))] }], self := (some (Val.ref (base + 0))), args := [] },
   { heap := h0 ++ [{ cls := "_Link", fields := [("expires", Val.int (-7)), ("key", Val.int (7)), ("next", Val.ref (base + 1)), ("prev", Val.ref (base + 1))] }, { cls := "_Link", fields := [("expires", Val.int (0)), ("key", Val.int (0)), ("next", Val.ref (base + 0)), ("prev", Val.ref (base + 0))] }], self := (some (Val.ref (base + 0))), args := [] }]
...
def dom_conform_cachetools___init___py__module__TLRUCache__Item___init : List Obs :=
  [{ case := { heap := h0 ++ [{ cls := "_Item", fields := [] }], self := (some (Val.ref (base + 0))), args := [Val.int (1), Val.int (5)] }, expected := EResult.val (Val.unit) },
   ...
   { case := { heap := h0 ++ [{ cls := "_Item", fields := [] }], self := (some (Val.ref (base + 0))), args := [Val.int (3), Val.int (6)] }, expected := EResult.val (Val.unit) }]
...
def dom_idempotent_cachetools___init___py__module__TLRUCache__Item___init : List Case :=
  [{ heap := h0 ++ [{ cls := "_Item", fields := [] }], self := (some (Val.ref (base + 0))), args := [Val.int (1), Val.int (5)] },
   ...
   { heap := h0 ++ [{ cls := "_Item", fields := [] }], self := (some (Val.ref (base + 0))), args := [Val.int (0), Val.int (0)] },
   { heap := h0 ++ [{ cls := "_Item", fields := [] }], self := (some (Val.ref (base + 0))), args := [Val.int (0), Val.int (-1)] },
   { heap := h0 ++ [{ cls := "_Item", fields := [] }], self := (some (Val.ref (base + 0))), args := [Val.int (2), Val.int (-1)] },
   { heap := h0 ++ [{ cls := "_Item", fields := [] }], self := (some (Val.ref (base + 0))), args := [Val.int (3), Val.int (2)] },
   { heap := h0 ++ [{ cls := "_Item", fields := [] }], self := (some (Val.ref (base + 0))), args := [Val.int (3), Val.int (1000000)] },
   { heap := h0 ++ [{ cls := "_Item", fields := [] }], self := (some (Val.ref (base + 0))), args := [Val.int (1000000), Val.int (1)] }]

theorem idempotent_cachetools___init___py__module__TLRUCache__Item___init : ((dom_idempotent_cachetools___init___py__module__TLRUCache__Item___init).all (lawIdempotent C FUEL f_cachetools___init___py__module__TLRUCache__Item___init__)) = true := by rfl

/-- Open: the same statement at **every** fuel budget ≥ `FUEL`. Proved only at `FUEL`. -/
def ob_idempotent_cachetools___init___py__module__TLRUCache__Item___init : Prop :=
  ∀ fuel, FUEL ≤ fuel → ((dom_idempotent_cachetools___init___py__module__TLRUCache__Item___init).all (lawIdempotent C fuel f_cachetools___init___py__module__TLRUCache__Item___init__)) = true
...
def dom_conform_cachetools___init___py__module__TLRUCache__Item___lt : List Obs :=
  [{ case := { heap := h0 ++ [{ cls := "_Item", fields := [("expires", Val.int (2)), ("key", Val.int (2)), ("removed", Val.bool false)] }, { cls := "_Item", fields := [("expires", Val.int (2)), ("key", Val.int (1)), ("removed", Val.bool false)] }], self := (some (Val.ref (base + 0))), args := [Val.ref (base + 1)] }, expected := EResult.val (Val.bool false) },
   ...
   { case := { heap := h0 ++ [{ cls := "_Item", fields := [("expires", Val.int (4)), ("key", Val.int (2)), ("removed", Val.bool false)] }, { cls := "_Item", fields := [("expires", Val.int (3)), ("key", Val.int (1)), ("removed", Val.bool false)] }], self := (some (Val.ref (base + 0))), args := [Val.ref (base + 1)] }, expected := EResult.val (Val.bool false) },
   { case := { heap := h0 ++ [{ cls := "_Item", fields := [("expires", Val.int (5)), ("key", Val.int (3)), ("removed", Val.bool false)] }, { cls := "_Item", fields := [("expires", Val.int (3)), ("key", Val.int (1)), ("removed", Val.bool false)] }], self := (some (Val.ref (base + 0))), args := [Val.ref (base + 1)] }, expected := EResult.val (Val.bool false) }]
...
def dom_runs_cachetools___init___py__module__TLRUCache__Item___lt : List Case :=
  [{ heap := h0 ++ [{ cls := "_Item", fields := [("expires", Val.int (2)), ("key", Val.int (2)), ("removed", Val.bool false)] }, { cls := "_Item", fields := [("expires", Val.int (2)), ("key", Val.int (1)), ("removed", Val.bool false)] }], self := (some (Val.ref (base + 0))), args := [Val.ref (base + 1)] },
   ...
   { heap := h0 ++ [{ cls := "_Item", fields := [("expires", Val.int (2)), ("key", Val.int (5)), ("removed", Val.bool false)] }, { cls := "_Item", fields := [("expires", Val.int (2)), ("key", Val.int (3)), ("removed", Val.bool false)] }], self := (some (Val.ref (base + 0))), args := [Val.ref (base + 1)] },
   { heap := h0 ++ [{ cls := "_Item", fields := [("expires", Val.int (2)), ("key", Val.int (5)), ("removed", Val.bool true)] }, { cls := "_Item", fields := [("expires", Val.int (1)), ("key", Val.int (7)), ("removed", Val.bool false)] }], self := (some (Val.ref (base + 0))), args := [Val.ref (base + 1)] },
   { heap := h0 ++ [{ cls := "_Item", fields := [("expires", Val.int (2)), ("key", Val.int (5)), ("removed", Val.bool false)] }, { cls := "_Item", fields := [("expires", Val.int (1000000)), ("key", Val.int (3)), ("removed", Val.bool false)] }], self := (some (Val.ref (base + 0))), args := [Val.ref (base + 1)] },
   { heap := h0 ++ [{ cls := "_Item", fields := [("expires", Val.int (-7)), ("key", Val.int (5)), ("removed", Val.bool false)] }, { cls := "_Item", fields := [("expires", Val.int (-7)), ("key", Val.int (3)), ("removed", Val.bool false)] }], self := (some (Val.ref (base + 0))), args := [Val.ref (base + 1)] },
   { heap := h0 ++ [{ cls := "_Item", fields := [("expires", Val.int (2)), ("key", Val.int (42)), ("removed", Val.bool false)] }, { cls := "_Item", fields := [("expires", Val.int (2)), ("key", Val.int (4)), ("removed", Val.bool true)] }], self := (some (Val.ref (base + 0))), args := [Val.ref (base + 1)] },
   { heap := h0 ++ [{ cls := "_Item", fields := [("expires", Val.int (0)), ("key", Val.int (0)), ("removed", Val.bool true)] }, { cls := "_Item", fields := [("expires", Val.int (2)), ("key", Val.int (4)), ("removed", Val.bool false)] }], self := (some (Val.ref (base + 0))), args := [Val.ref (base + 1)] }]
...
def dom_runs_cachetools___init___py__module__TLRUCache___contains : List Case :=
  [{ heap := h0 ++ [{ cls := "TLRUTestCache", fields := [("_Cache__data", Val.dict []), ("_Cache__currsize", Val.int (0)), ("_Cache__maxsize", Val.int (2)), ("_TimedCache__timer", Val.ref (base + 1)), ("_TLRUCache__items", Val.dict []), ("_TLRUCache__order", Val.list []), ("_TLRUCache__ttu", Val.fn "default_ttu")] }, { cls := "_Timer", fields := [("_Timer__timer", Val.ref (base + 2)), ("_Timer__nesting", Val.int (0)), ("_Timer__time", Val.int (0))] }, { cls := "Timer", fields := [("auto", Val.bool false), ("time", Val.int (0))] }], self := (some (Val.ref (base + 0))), args := [Val.int (1)] },
   ...
   { heap := h0 ++ [{ cls := "TLRUTestCache", fields := [("_Cache__data", Val.dict []), ("_Cache__currsize", Val.int (0)), ("_Cache__maxsize", Val.int (-1)), ("_TimedCache__timer", Val.ref (base + 1)), ("_TLRUCache__items", Val.dict []), ("_TLRUCache__order", Val.list []), ("_TLRUCache__ttu", Val.fn "default_ttu")] }, { cls := "_Timer", fields := [("_Timer__timer", Val.ref (base + 2)), ("_Timer__nesting", Val.int (0)), ("_Timer__time", Val.int (0))] }, { cls := "Timer", fields := [("auto", Val.bool false), ("time", Val.int (0))] }], self := (some (Val.ref (base + 0))), args := [Val.int (1)] },
   { heap := h0 ++ [{ cls := "TLRUTestCache", fields := [("_Cache__data", Val.dict []), ("_Cache__currsize", Val.int (0)), ("_Cache__maxsize", Val.int (2)), ("_TimedCache__timer", Val.ref (base + 1)), ("_TLRUCache__items", Val.dict []), ("_TLRUCache__order", Val.list []), ("_TLRUCache__ttu", Val.fn "default_ttu")] }, { cls := "_Timer", fields := [("_Timer__timer", Val.ref (base + 2)), ("_Timer__nesting", Val.int (1)), ("_Timer__time", Val.int (0))] }, { cls := "Timer", fields := [("auto", Val.bool false), ("time", Val.int (0))] }], self := (some (Val.ref (base + 0))), args := [Val.int (2)] },
   { heap := h0 ++ [{ cls := "TLRUTestCache", fields := [("_Cache__data", Val.dict []), ("_Cache__currsize", Val.int (0)), ("_Cache__maxsize", Val.int (7)), ("_TimedCache__timer", Val.ref (base + 1)), ("_TLRUCache__items", Val.dict []), ("_TLRUCache__order", Val.list []), ("_TLRUCache__ttu", Val.fn "default_ttu")] }, { cls := "_Timer", fields := [("_Timer__timer", Val.ref (base + 2)), ("_Timer__nesting", Val.int (-1)), ("_Timer__time", Val.int (0))] }, { cls := "Timer", fields := [("auto", Val.bool true), ("time", Val.int (1000000))] }], self := (some (Val.ref (base + 0))), args := [Val.int (1000000)] },
   { heap := h0 ++ [{ cls := "TLRUTestCache", fields := [("_Cache__data", Val.dict []), ("_Cache__currsize", Val.int (1)), ("_Cache__maxsize", Val.int (2)), ("_TimedCache__timer", Val.ref (base + 1)), ("_TLRUCache__items", Val.dict []), ("_TLRUCache__order", Val.list []), ("_TLRUCache__ttu", Val.fn "default_ttu")] }, { cls := "_Timer", fields := [("_Timer__timer", Val.ref (base + 2)), ("_Timer__nesting", Val.int (-7)), ("_Timer__time", Val.int (0))] }, { cls := "Timer", fields := [("auto", Val.bool false), ("time", Val.int (0))] }], self := (some (Val.ref (base + 0))), args := [Val.int (1)] },
   { heap := h0 ++ [{ cls := "TLRUTestCache", fields := [("_Cache__data", Val.dict []), ("_Cache__currsize", Val.int (0)), ("_Cache__maxsize", Val.int (2)), ("_TimedCache__timer", Val.ref (base + 1)), ("_TLRUCache__items", Val.dict []), ("_TLRUCache__order", Val.list []), ("_TLRUCache__ttu", Val.fn "default_ttu")] }, { cls := "_Timer", fields := [("_Timer__timer", Val.ref (base + 2)), ("_Timer__nesting", Val.int (0)), ("_Timer__time", Val.int (1000000))] }, { cls := "Timer", fields := [("auto", Val.bool false), ("time", Val.int (0))] }], self := (some (Val.ref (base + 0))), args := [Val.int (0)] },
   { heap := h0 ++ [{ cls := "TLRUTestCache", fields := [("_Cache__data", Val.dict []), ("_Cache__currsize", Val.int (0)), ("_Cache__maxsize", Val.int (0)), ("_TimedCache__timer", Val.ref (base + 1)), ("_TLRUCache__items", Val.dict []), ("_TLRUCache__order", Val.list []), ("_TLRUCache__ttu", Val.fn "default_ttu")] }, { cls := "_Timer", fields := [("_Timer__timer", Val.ref (base + 2)), ("_Timer__nesting", Val.int (0)), ("_Timer__time", Val.int (0))] }, { cls := "Timer", fields := [("auto", Val.bool false), ("time", Val.int (0))] }], self := (some (Val.ref (base + 0))), args := [Val.int (1)] }]
...
def dom_idempotent_cachetools___init___py__module__cached : List Case :=
  [{ heap := h0 ++ [{ cls := "Cache", fields := [("_Cache__data", Val.dict []), ("_Cache__currsize", Val.int (0)), ("_Cache__maxsize", Val.int (2))] }], self := none, args := [Val.ref (base + 0), Val.fn "hashkey", Val.unit, Val.unit, Val.bool false] },
   ...
   { heap := h0 ++ [{ cls := "Cache", fields := [("_Cache__data", Val.dict []), ("_Cache__currsize", Val.int (0)), ("_Cache__maxsize", Val.int (2))] }, { cls := "CountedCondition", fields := [("count", Val.int (0)), ("wait_count", Val.int (0)), ("notify_count", Val.int (2))] }], self := none, args := [Val.ref (base + 0), Val.fn "hashkey", Val.int (0), Val.ref (base + 1), Val.bool true] },
   { heap := h0 ++ [{ cls := "Cache", fields := [("_Cache__data", Val.dict []), ("_Cache__currsize", Val.int (0)), ("_Cache__maxsize", Val.int (-7))] }, { cls := "CountedCondition", fields := [("count", Val.int (0)), ("wait_count", Val.int (0)), ("notify_count", Val.int (0))] }], self := none, args := [Val.ref (base + 0), Val.fn "hashkey", Val.unit, Val.ref (base + 1), Val.bool true] },
   { heap := h0 ++ [{ cls := "Cache", fields := [("_Cache__data", Val.dict []), ("_Cache__currsize", Val.int (7)), ("_Cache__maxsize", Val.int (2))] }, { cls := "CountedCondition", fields := [("count", Val.int (0)), ("wait_count", Val.int (1000000)), ("notify_count", Val.int (0))] }], self := none, args := [Val.ref (base + 0), Val.fn "hashkey", Val.int (0), Val.ref (base + 1), Val.bool true] },
   ...
   { heap := h0 ++ [{ cls := "Cache", fields := [("_Cache__data", Val.dict []), ("_Cache__currsize", Val.int (0)), ("_Cache__maxsize", Val.int (2))] }, { cls := "CountedLock", fields := [("count", Val.int (7))] }], self := none, args := [Val.ref (base + 0), Val.fn "hashkey", Val.ref (base + 1), Val.int (0), Val.bool true] },
   { heap := h0 ++ [{ cls := "Cache", fields := [("_Cache__data", Val.dict []), ("_Cache__currsize", Val.int (1)), ("_Cache__maxsize", Val.int (2))] }, { cls := "CountedLock", fields := [("count", Val.int (0))] }], self := none, args := [Val.ref (base + 0), Val.fn "hashkey", Val.ref (base + 1), Val.int (0), Val.bool true] }]
...
def dom_idempotent_cachetools___init___py__module__cachedmethod : List Case :=
  [{ heap := h0 ++ [], self := none, args := [Val.fn "Cached.<lambda>", Val.fn "methodkey", Val.unit, Val.unit, Val.bool false] },
   ...
   { heap := h0 ++ [], self := none, args := [Val.fn "Cached.<lambda>", Val.fn "methodkey", Val.fn "Cached.<lambda>", Val.int (0), Val.bool false] },
...
def dom_idempotent_cachetools_func_py__module___cache : List Case :=
  [{ heap := h0 ++ [{ cls := "FIFOCache", fields := [("_Cache__data", Val.dict []), ("_Cache__currsize", Val.int (0)), ("_Cache__maxsize", Val.int (2)), ("_FIFOCache__order", Val.dict [])] }], self := none, args := [Val.ref (base + 0), Val.int (2), Val.bool false] },
   ...
   { heap := h0 ++ [{ cls := "FIFOCache", fields := [("_Cache__data", Val.dict []), ("_Cache__currsize", Val.int (1000000)), ("_Cache__maxsize", Val.int (7)), ("_FIFOCache__order", Val.dict [])] }], self := none, args := [Val.ref (base + 0), Val.int (128), Val.bool true] },
   ...
   { heap := h0 ++ [{ cls := "FIFOCache", fields := [("_Cache__data", Val.dict []), ("_Cache__currsize", Val.int (0)), ("_Cache__maxsize", Val.int (-1)), ("_FIFOCache__order", Val.dict [])] }], self := none, args := [Val.ref (base + 0), Val.int (1000000), Val.bool true] },
   { heap := h0 ++ [{ cls := "FIFOCache", fields := [("_Cache__data", Val.dict []), ("_Cache__currsize", Val.int (0)), ("_Cache__maxsize", Val.int (7)), ("_FIFOCache__order", Val.dict [])] }], self := none, args := [Val.ref (base + 0), Val.int (-1), Val.bool true] },
   { heap := h0 ++ [{ cls := "FIFOCache", fields := [("_Cache__data", Val.dict []), ("_Cache__currsize", Val.int (0)), ("_Cache__maxsize", Val.int (0)), ("_FIFOCache__order", Val.dict [])] }], self := none, args := [Val.ref (base + 0), Val.int (2), Val.bool true] }]
...
def obligations : List OpenObligation :=
  [{ name := "ob_conform_cachetools___init___py__module___DefaultSize___getitem", source := "cross-runtime (\u00a74.4)", subject := "cachetools/__init__.py:<module>._DefaultSize.__getitem__", reason := "proved at FUEL only; fuel-independence unproved" },
   ...
   { name := "ob_nonneg_cachetools___init___py__module__Cache___len", source := "algebraic (\u00a74.3)", subject := "cachetools/__init__.py:<module>.Cache.__len__", reason := "proved at FUEL only; fuel-independence unproved" },
   ...
   { name := "ob_idempotent_cachetools___init___py__module__TLRUCache__Item___init", source := "algebraic (\u00a74.3)", subject := "cachetools/__init__.py:<module>.TLRUCache._Item.__init__", reason := "proved at FUEL only; fuel-independence unproved" },
...
#audit_depends nonneg_cachetools___init___py__module__Cache___len on f_cachetools___init___py__module__Cache___len__
...
#audit_depends idempotent_cachetools___init___py__module__TLRUCache__Item___init on f_cachetools___init___py__module__TLRUCache__Item___init__
