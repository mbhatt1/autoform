...
namespace Autoform.SpecsGen.V8Base.Part48

def ob_involutive_v8_base_internal_MakeStrictNum_StrictNumeric_T : Prop :=
  ∀ fuel, FUEL ≤ fuel → ((dom_involutive_v8_base_internal_MakeStrictNum_StrictNumeric_T).all (lawInvolutive C fuel f_v8_base_internal_MakeStrictNum_StrictNumeric_T_)) = true
...
end Autoform.SpecsGen.V8Base.Part48
