...
theorem runs_v8_base_hash64_uint64_t_uint64_t_at_FUEL : ((dom_runs_v8_base_hash64_uint64_t_uint64_t).all (lawRuns C FUEL f_v8_base_hash64_uint64_t_uint64_t_)) = true := by rfl


theorem returns_v8_base_hash64_uint64_t_uint64_t_at_FUEL : ((dom_returns_v8_base_hash64_uint64_t_uint64_t).all (lawReturns C FUEL f_v8_base_hash64_uint64_t_uint64_t_)) = true := by rfl
